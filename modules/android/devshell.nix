      ...
      in
      {
        ...
        shellHook =
          ...
          ''
            ...
            # Sync build files
            ${pkgs.sync-android-build-files}/bin/sync-android-build-files "${androidDir}" "${cfg.settings.platform.compileSdkVersion}" "${cfg.settings.androidGradlePlugin.version}" "${pkgs.devmods.gradle-wrapper}"
            set +e
          '';
