...
in
{
  ...
  options.devProfiles.flutter-dev-env = {
    ...
    android-dev-env = options.devProfiles.android-dev-env // {
  ...
  config = lib.mkIf cfg.enable {
    # Always enable android dev env profile if this flutter dev env profile is enabled
    # Reference values to android-dev-env from this profiles 'android-dev-env' options
    devProfiles.android-dev-env = cfg.android-dev-env // {
      enable = true;
    };
    # devProfiles.android-dev-env.presets = cfg.android.presets;
